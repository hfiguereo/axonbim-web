...
4. **F5-S cerrado** (2026-08-07). **F8 Playwright oleada 1 aprobado** (2026-08-08; estrecho, A+B, local) — ver `docs/validation/playwright-f8.md`. No IFC/OCCT/workplanes/CI-e2e sin auth.
